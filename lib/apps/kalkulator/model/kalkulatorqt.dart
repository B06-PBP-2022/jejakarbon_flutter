...
class UserLastCalculation {
  ...
  factory UserLastCalculation.fromJson(Map<String, dynamic> json) =>
      UserLastCalculation(
        result: json["carbon_print_total"].toDouble(),
        sum: json["hasil_kalkulasi"].toDouble(),
      );
}
